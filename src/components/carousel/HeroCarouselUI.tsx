  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative h-[500px] md:h-[65vh] lg:h-[75vh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-30 flex flex-col items-start justify-end pb-20 md:pb-24 pointer-events-none bg-gradient-to-r from-black/40 via-black/15 to-transparent">
