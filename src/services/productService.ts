...
export const productService = {
  ...
  getAvailableProducts: (): Product[] => {
    try {
      ...
      // REMOVED: Dummy data generation if products.length === 0
      // The Catalog page will handle the empty state.
      // console.log("getAvailableProducts called, products from getAll:", products);
  ...
  getFeaturedProducts: (): Product[] => {
    try {
      ...
      // REMOVED: Dummy data generation if no actual featured products found
      // The component using this should handle the empty state.
      // console.log("getFeaturedProducts called, products from getAll:", products);
