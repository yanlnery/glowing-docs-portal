...
const Catalog = () => {
  ...
  const filterOptions = [
    { label: 'Todos', category: 'all', subcategory: 'all' },
    { label: 'Serpentes', category: 'serpente', subcategory: 'all' },
    { label: 'Colubrídeos', category: 'serpente', subcategory: 'colubrideos' },
    { label: 'Boídeos', category: 'serpente', subcategory: 'boideos' },
    { label: 'Lagartos', category: 'lagarto', subcategory: 'all' },
    { label: 'Pequenos', category: 'lagarto', subcategory: 'pequenos' },
    { label: 'Grandes', category: 'lagarto', subcategory: 'grandes' },
    { label: 'Quelônios', category: 'quelonio', subcategory: 'all' },
    { label: 'Terrestres', category: 'quelonio', subcategory: 'terrestres' },
    { label: 'Aquáticos', category: 'quelonio', subcategory: 'aquaticos' },
  ];
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            {filterOptions.map((option, index) => (
              <Button 
                key={index}
                variant={(categoryFilter === option.category && subcategoryFilter === option.subcategory) ? "secondary" : "outline"} 
                size="sm"
                onClick={() => handleFilterClick(option.category as ProductCategory | 'all', option.subcategory as ProductSubcategory | 'all')}
