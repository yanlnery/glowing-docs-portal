  ...
  return (
    <>
      <SEO
        ...
        description="Entre em contato com o Pet Serpentes. Tire dúvidas sobre répteis, consulte disponibilidade de animais ou agende uma visita ao criadouro legalizado pelo IBAMA."
        canonical="/contato"
      />
